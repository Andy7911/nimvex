...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    ContactUs: Schema.Attribute.Blocks;
    BottomText: Schema.Attribute.String;
    FooterLinks: Schema.Attribute.Component<'elements.link-item', true>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    MarketingInfo: Schema.Attribute.Component<'blocks.maketing-info', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ProcessCard: Schema.Attribute.Component<'elements.process-card', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
